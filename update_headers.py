          ...
          <ul class="hdnav-box">
            ...
            <li class="menu-item menu-item-has-children">
              ...
              <ul class="sub-menu">
                ...
                <!-- Level 1: Vector Signal Generator -->
                <li class="menu-item menu-item-has-children">
...
for filepath in html_files:
    ...
    content = re.sub(r'href="css/style\.css(?:\?v=[a-zA-Z0-9_-]+)?"', 'href="css/style.css?v=20260529-v6"', content)
    content = re.sub(r'href="css/product-category\.css(?:\?v=[a-zA-Z0-9_-]+)?"', 'href="css/product-category.css?v=20260529-v6"', content)
    content = re.sub(r'src="js/main\.js(?:\?v=[a-zA-Z0-9_-]+)?"', 'src="js/main.js?v=20260529-v6"', content)
